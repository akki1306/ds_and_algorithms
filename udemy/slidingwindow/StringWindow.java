...
/**
 * Given two strings, one big udemy.string and one small udemy.string, find the 'smallest window'
 * in the big udemy.string that contains all the characters of the small udemy.string.
 *
 * - Window can have additional characters than required
 * - If the small udemy.string has duplicates, then those duplicates must be present
