 ...
 *
 * Given an input udemy.string (s) and a pattern (p), implement wildcard pattern matching
 * algorithm that finds if wildcard pattern is matched with input udemy.string.
 *
 * The wildcard pattern can include the characters '?' and '*':
 *
 * '?' matches any single character
 * '*' matches any sequence of characters (including the empty sequence)
 * The matching should cover entire input udemy.string (not partial)
 *
 * For example:
 *
 * Text = "baaabab"
